...
// Onboarding "screen 1" — the welcome screen. Lives at an unambiguous /welcome
// route (NOT /) so logout/delete can return here from inside the tabs without
// hitting the /(tabs) index, which also resolves to "/". See app/index.tsx.
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.footer}>
        <View style={styles.noAdsPill}><Text style={styles.noAdsText}>NO ADS, EVER</Text></View>
...
const styles = StyleSheet.create({
  ...
  noAdsPill: { alignSelf: 'center', backgroundColor: colors.successSoft, borderRadius: 999, paddingVertical: 8, paddingHorizontal: 16 },
  noAdsText: { fontFamily: fonts.semibold, fontSize: 12.5, letterSpacing: 1.4, color: colors.success },
